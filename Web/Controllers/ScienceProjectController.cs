...
{
    [Authorize]
    public class ScienceProjectController : Controller
    {
        ...
        public ScienceProjectController(IUserRepository userRepository, IUserPermissionsRepository userPermissionsRepository)
        {
